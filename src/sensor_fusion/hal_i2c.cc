 ...
 *  found in files like driver_fxas21002.c and driver_fxos8700.c.  For example,
...
/**
 * @file hal_i2c.cc
 * @brief The hal_i2c.cc file contains definitions for low-level interface functions
